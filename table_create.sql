...
-- After creating ENDERECO, add the foreign key in PESSOA
...
CREATE TABLE TECNICO (
    CPF VARCHAR2(11 CHAR) NOT NULL,
    Registro_Tecnico VARCHAR2(50 CHAR), -- Ex: Registro no conselho de técnicos
...
CREATE TABLE AGENDAMENTO (
    Codigo NUMBER GENERATED BY DEFAULT AS IDENTITY NOT NULL, -- CLÁUSULA DE AUTO_INCREMENT
